package Crypt::JWS::OpenSSL::Local;
$Crypt::JWS::OpenSSL::Local::VERSION = '0.001';
$Crypt::JWS::OpenSSL::Local::HAS_OPENSSL3 = HASOPENSSL3ANSWER;
...
It may be that you have a different version of OpenSSL available at run time. If so, you can set
C<$Crypt::JWS::OpenSSL::Local::HAS_OPENSSL3> as required.
