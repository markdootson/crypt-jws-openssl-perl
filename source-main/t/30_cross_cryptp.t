...
BEGIN {
    eval {
        require Crypt::Perl;
        Crypt::Perl->VERSION(0.38);
    };
    
    if( $@ ) {
        plan skip_all => qq(required version of Crypt::Perl not installed for comparision);
        done_testing;
    };
...
our $H2NAME = 'Perl';
our $H2 = CmpCryptPerl->new( 'JSON' => JSON::MaybeXS->new->canonical->utf8(1) );
$H2->throw_errors(1);
